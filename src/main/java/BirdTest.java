...
public class BirdTest {
    ...
    public void testBird() {
        Assert.assertTrue(Modifier.isAbstract(Bird.class.getModifiers()), "Bird class is not abstract");
    }

    @Test()
    public void testFlyingBird() {
        Assert.assertTrue(Modifier.isAbstract(FlyingBird.class.getModifiers()),
                "Bird class is not abstract");

        Assert.assertTrue(Bird.class.isAssignableFrom(FlyingBird.class),
                "FlyingBird class does not extend Bird class");
    }

    @Test()
    public void testNonFlyingBird() {
        Assert.assertTrue(Modifier.isAbstract(NonFlyingBird.class.getModifiers()),
                "Bird class is not abstract");

        Assert.assertTrue(Bird.class.isAssignableFrom(NonFlyingBird.class),
